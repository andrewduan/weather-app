...
describe('forecast', () => {
  beforeEach(() => {
    jest.spyOn(dateHelper, 'isDaytime').mockReturnValueOnce(true);
    jest.spyOn(dateHelper, 'getDay').mockReturnValueOnce('Sunday');
    jest.spyOn(dateHelper, 'isToday').mockReturnValueOnce(false);
  });
